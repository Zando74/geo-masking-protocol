 ...
 * Alice is the Prover
 * Bob is the Verifier
 * application of the protocol assuming dishonest parties and lie at step 2
 */
const protocolWithCheatStep2 = async (x,y,center,radius) => { 
  ...
  aliceAnswer2 = bigInt.randBetween(1, bigInt.one.shiftLeft(512) ); // LIE
  ...
  const aliceDecryptionStep4 = await answer4(bobresultStep4.F,aliceKeys);
  ...
  if(finalCheck) {//((finalCheck >= 0) && (finalCheck <= (radius ** 2)))
...
module.exports = protocolWithCheatStep2;