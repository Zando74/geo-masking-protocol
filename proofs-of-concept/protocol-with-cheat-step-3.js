 ...
 * Alice is the Prover
 * Bob is the Verifier
 * application of the protocol assuming dishonest parties and lie at step 3
 */
const protocolWithCheatStep3 = async (x,y,center,radius) => { 
  ...
  aliceAnswer3 = bigInt.randBetween(1, bigInt.one.shiftLeft(512) ); // LIE
...
module.exports = protocolWithCheatStep3;